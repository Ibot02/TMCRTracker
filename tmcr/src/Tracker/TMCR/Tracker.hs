...
getTrackerFor logicFile = do
    ...
    let (logic, dungeonLocations) = case logic' of
        ...
        itemWidget = TrackerWidgetGrid [
                        ...
                        [SimpleItem "KinstoneX.YellowTotemProng", SimpleItem "KinstoneX.YellowCrown", SimpleItem "KinstoneX.YellowTornadoProng", SimpleItem "CarlovMedal", SimpleItem "PieceOfHeart", SimpleItem "FastSpin", SimpleItem "SmallKey.1E", SpecialLocation "KingGift" prizes, SimpleItem "SmallKey.0x1D", SimpleItem "BigKey.0x1D"]]
