...
getTrackerFor logicFile = do
    ...
    let (logic, dungeonLocations) = case logic' of
        ...
        extras = mempty
            ...
            & itemAliases .~ [(item <> dungeonSubtype, item <> dungeonName ) | item <- ["SmallKey", "BigKey"], (dungeonSubtype, dungeonName) <- [(".18",":Deepwood"),(".19",":FlameCave"),(".1A",":Fortress"),(".1B",":Droplets"),(".1C",":Palace"),(".1D",":DHC"),(".1E",":Crypt")]]
            & itemMaxAmounts .~ Trie (Map.fromList [("SmithSword", 5), ("Boomerang", 2), ("SmallKey.18", 4), ("Shield", 2), ("BombBag", 4), ("SmallKey.19", 2), ("Bow", 2), ("SmallKey.1A", 4), ("Bottle4", 4), ("Wallet", 3), ("SmallKey.1B", 4), ("HeartContainer", 17), ("SmallKey.1C", 6), ("KinstoneX.YellowTotemProng", 3), ("KinstoneX.YellowTornadoProng", 5), ("PieceOfHeart", 44), ("SmallKey.1E", 3), ("SmallKey.1D", 5)]) mempty
        ...
        itemWidget = TrackerWidgetGrid [
                        [SimpleItem "SmithSword", SimpleItem "GustJar", SimpleItem "PacciCane", SimpleItem "Boomerang", SimpleItem "Flippers", SimpleItem "SpinAttack", SimpleItem "SwordBeam", SpecialLocation "DeepwoodPrize" prizes, SimpleItem "SmallKey.18", SimpleItem "BigKey.18", SimpleItem "EarthElement"],
                        [SimpleItem "Shield", SimpleItem "MoleMitts", SimpleItem "LanternOff", SimpleItem "BombBag", SimpleItem "GripRing", SimpleItem "RockBreaker", SimpleItem "PerilBeam", SpecialLocation "CoFPrize" prizes, SimpleItem "SmallKey.19", SimpleItem "BigKey.19", SimpleItem "FireElement"],
                        [SimpleItem "PegasusBoots", SimpleItem "RocsCape", SimpleItem "Ocarina", SimpleItem "Bow", SimpleItem "PowerBracelets", SimpleItem "DashAttack", SimpleItem "RollAttack", SpecialLocation "FortressPrize" prizes, SimpleItem "SmallKey.1A", SimpleItem "BigKey.1A", SimpleItem "WindElement"],
                        [SimpleItem "Bottle4", SimpleItem "DogFoodBottle", SimpleItem "WakeUpMushroom", SimpleItem "JabberNut", SimpleItem "Wallet", SimpleItem "DownThrust", SimpleItem "FastSplit", SpecialLocation "DropletsPrize" prizes, SimpleItem "SmallKey.1B", SimpleItem "BigKey.1B", SimpleItem "WaterElement"],
                        [ComboItem "Books", SimpleItem "GraveyardKey", SimpleItem "LonLonKey", SimpleItem "TingleTrophy", SimpleItem "HeartContainer", SimpleItem "GreatSpin", SimpleItem "LongSpin", SpecialLocation "PalacePrize" prizes, SimpleItem "SmallKey.1C", SimpleItem "BigKey.1C"],
                        [SimpleItem "KinstoneX.YellowTotemProng", SimpleItem "KinstoneX.YellowCrown", SimpleItem "KinstoneX.YellowTornadoProng", SimpleItem "CarlovMedal", SimpleItem "PieceOfHeart", SimpleItem "FastSpin", SimpleItem "SmallKey.1E", SpecialLocation "KingGift" prizes, SimpleItem "SmallKey.1D", SimpleItem "BigKey.1D"]]
